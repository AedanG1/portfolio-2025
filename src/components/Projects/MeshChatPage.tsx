  ...
  return (
    <main className="space-y-20">
      ...
      <div className="flex flex-col-reverse md:flex-row gap-20">
        ...
        <aside className="basis-1/4 md:sticky md:top-32 md:self-start py-6 px-2 frame-bg frame-border">
          <div className="space-y-8 frame-inner-bg py-8 px-4">
            <div className="space-y-2">
              <h2 className="text-2xl font-worn">View Project</h2>
              <a
            ...
            <div className="hidden md:block">
              <h2 className="text-2xl mb-2 font-worn">Contents</h2>
              <ul className="text-sm font-worn">
                <li>
                  <a
                    href="#overview"
