    ...
    <main className="space-y-20 mb-100">
      ...
      <div className="flex flex-col-reverse md:flex-row gap-20">
        <article className="basis-3/4 space-y-8">
          ...
          <hr></hr>
          <div className="space-y-2">
            <h3 id="library" className="text-2xl mt-2 scroll-mt-24">
              Library
            </h3>
            <img
              src={filter}
          ...
          <div className="space-y-2">
            <h3 id="upload-video" className="text-2xl mt-2 scroll-mt-24">
              Upload Video
            </h3>
            <img
              src={upload}
          ...
          <div className="space-y-2">
            <h3 id="aws" className="text-2xl mt-2 scroll-mt-24">
              AWS Pipeline
            </h3>
          ...
          <div className="space-y-2">
            <h3 id="thumbnail" className="text-2xl mt-2 scroll-mt-24">
          ...
          <div className="space-y-2">
            <h3 id="tags" className="text-2xl mt-2 scroll-mt-24">
              Managing Tags
            </h3>
            <img
              src={editTags}
          ...
          <div className="space-y-2">
            <h3 id="videos" className="text-2xl mt-2 scroll-mt-24">
              Managing Videos
            </h3>
            <img
              src={editVideo}
        ...
        <aside className="basis-1/4 md:sticky md:top-32 md:self-start space-y-8">
          <div className="space-y-2">
            ...
            <a
              ...
              href="https://github.com/AedanG1/bjjvs-app"
              target="/blank"
            >
