            ...
            <div className="flex flex-col-reverse md:flex-row gap-20">
                <article className="basis-3/4 space-y-8">
                    <div className="space-y-2">
                        <img src={hero} loading="lazy" alt="A screenshot of the homepage for a Video Sharing app. Shows a grid of videos"/>
                    ...
                    <div className="space-y-2">
                        ...
                        <img src={filter} loading="lazy" alt="A screenshot of a the Library page of the Video Sharing app. A filter dropdown is shown"/>
                    ...
                    <div className="space-y-2">
                        ...
                        <img src={upload} loading="lazy" alt="A screenshot of the admin dashboard"/>
                        <p>
                    ...
                    <div className="space-y-2">
                        ...
                        <img src={thumbnail} loading="lazy" alt="A screenshot of the thumbnail choosing feature"/>
                    ...
                    <div className="space-y-2">
                        ...
                        <img src={editTags} loading="lazy" alt="A screenshot of the manage tags form"/>
                    ...
                    <div className="space-y-2">
                        ...
                        <img src={editVideo} loading="lazy" alt="A screenshot of the manage videos form"/>
                ...
                <aside className="basis-1/4 md:sticky md:top-32 md:self-start space-y-8">
                    ...
                    <div className="hidden md:block">
                        ...
                        <ul>
                            <li><a href="#overview" className="transition duration-200 hover:text-sky-400/80">Overview</a></li>
                            <li><a href="#screenshots" className="transition duration-200 hover:text-sky-400/80">Screenshots</a></li>
                            <li><a href="#library" className="ml-6 transition duration-200 hover:text-sky-400/80">⌙ Library</a></li>
                            <li><a href="#upload-video" className="ml-6 transition duration-200 hover:text-sky-400/80">⌙ Upload Video</a></li>
                            <li><a href="#aws" className="ml-6 transition duration-200 hover:text-sky-400/80">⌙ AWS Pipeline</a></li>
                            <li><a href="#thumbnail" className="ml-6 transition duration-200 hover:text-sky-400/80">⌙ Choosing a Thumbnail</a></li>
                            <li><a href="#tags" className="ml-6 transition duration-200 hover:text-sky-400/80">⌙ Managing Tags</a></li>
                            <li><a href="#videos" className="ml-6 transition duration-200 hover:text-sky-400/80">⌙ Managing Videos</a></li>
                        </ul>
                    </div>
                </aside>
            </div>
